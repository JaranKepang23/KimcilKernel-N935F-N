...
echo	#!/su/xbin/busybox sh
else if [ -e /sbin/busybox ]; then
echo	#!/sbin/busybox sh
else
echo	#!/system/xbin/busybox sh
fi;
fi;
...
cortexbrain_kernel=$(cat /res/synapse/Kimcil/cortexbrain_kernel);
cortexbrain_system=$(cat /res/synapse/Kimcil/cortexbrain_system);
cortexbrain_wifi_auto=$(cat /res/synapse/Kimcil/cortexbrain_wifi_auto);
cortexbrain_wifi_auto_scron=$(cat /res/synapse/Kimcil/cortexbrain_wifi_auto_scron);
cortexbrain_wifi_auto_scroff=$(cat /res/synapse/Kimcil/cortexbrain_wifi_auto_scroff);
cortexbrain_wifi_delay_scron_enable=$(($(cat /res/synapse/Kimcil/cortexbrain_wifi_delay_scron_enable) * 60 ));
cortexbrain_wifi_delay_scron_disable=$(($(cat /res/synapse/Kimcil/cortexbrain_wifi_delay_scron_disable) * 360 ));
cortexbrain_wifi_delay_scroff_enable=$(($(cat /res/synapse/Kimcil/cortexbrain_wifi_delay_scroff_enable) * 60 ));
cortexbrain_wifi_delay_scroff_disable=$(($(cat /res/synapse/Kimcil/cortexbrain_wifi_delay_scroff_disable) * 360 ));
cortexbrain_media_manager=$(cat /res/synapse/Kimcil/cortexbrain_media_manager);
cortexbrain_nmi_auto=$(cat /res/synapse/Kimcil/cortexbrain_nmi_auto);
cortexbrain_doze_auto=$(cat /res/synapse/Kimcil/cortexbrain_doze_auto);
cortexbrain_alpm_auto=$(cat /res/synapse/Kimcil/cortexbrain_alpm_auto);
cortexbrain_lux=$(cat /res/synapse/Kimcil/cortexbrain_lux);
cortexbrain_power_aware_sched=$(cat /res/synapse/Kimcil/cortexbrain_power_aware_sched);
cortexbrain_hmp_little_pack=$(cat /res/synapse/Kimcil/cortexbrain_hmp_little_pack);
cortexbrain_pewq=$(cat /res/synapse/Kimcil/cortexbrain_pewq);
